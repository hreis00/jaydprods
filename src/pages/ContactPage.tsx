...
export default function ContactPage() {
  ...
  return (
    <div style={{ background: '#000', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      {/* ── HEADER ── */}
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: '72px', padding: '0 48px', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
      ...
      {/* ── CONTEÚDO ── */}
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '80px 48px', gap: '80px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: '16px', flexWrap: 'wrap', justifyContent: 'center' }}>
          <a
            ...
            style={{ display: 'inline-flex', alignItems: 'center', gap: '10px', border: '1px solid rgba(255,255,255,0.25)', borderRadius: '999px', padding: '18px 48px', fontFamily: "'Inter', sans-serif", fontWeight: 400, fontSize: '11px', letterSpacing: '0.15em', textTransform: 'uppercase', color: '#fff', textDecoration: 'none', background: 'transparent', transition: 'border-color 0.3s, background 0.3s, color 0.3s' }}
          ...
          <a
            href="https://www.instagram.com/jaydprods/"
            target="_blank"
            rel="noopener noreferrer"
            style={{ display: 'inline-flex', alignItems: 'center', gap: '10px', border: '1px solid rgba(255,255,255,0.25)', borderRadius: '999px', padding: '18px 48px', fontFamily: "'Inter', sans-serif", fontWeight: 400, fontSize: '11px', letterSpacing: '0.15em', textTransform: 'uppercase', color: '#fff', textDecoration: 'none', background: 'transparent', transition: 'border-color 0.3s, background 0.3s, color 0.3s' }}
            onMouseEnter={e => { e.currentTarget.style.borderColor = '#fff'; e.currentTarget.style.background = '#fff'; e.currentTarget.style.color = '#000' }}
          ...
          <a
            href="mailto:jaydprods@gmail.com"
            style={{ display: 'inline-flex', alignItems: 'center', gap: '10px', border: '1px solid rgba(255,255,255,0.25)', borderRadius: '999px', padding: '18px 48px', fontFamily: "'Inter', sans-serif", fontWeight: 400, fontSize: '11px', letterSpacing: '0.15em', textTransform: 'uppercase', color: '#fff', textDecoration: 'none', background: 'transparent', transition: 'border-color 0.3s, background 0.3s, color 0.3s' }}
            onMouseEnter={e => { e.currentTarget.style.borderColor = '#fff'; e.currentTarget.style.background = '#fff'; e.currentTarget.style.color = '#000' }}
            onMouseLeave={e => { e.currentTarget.style.borderColor = 'rgba(255,255,255,0.25)'; e.currentTarget.style.background = 'transparent'; e.currentTarget.style.color = '#fff' }}
          >
